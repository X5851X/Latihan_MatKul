...
void create(string judul, string penulis, string genre, string penerbit, string bahasa, int tahun) 
{
    newNode = new Buku();
    newNode->judul      = judul;
...
void push(string judul, string penulis, string genre, string penerbit, string bahasa, int tahun)
{
    newNode = new Buku();
    newNode->judul      = judul;
    newNode->penulis    = penulis;
